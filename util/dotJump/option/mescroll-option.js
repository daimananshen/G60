...
function initMeScroll(mescrollId, options) {
	...
	// htmlContent += '<img class="downwarp-ball" src="/项目/g60/xm/web/util/dotJump/option/mescroll-ball.svg"/>';
    htmlContent += '<img class="downwarp-ball" src="http://47.101.195.208/web/util/dotJump/option/mescroll-ball.svg"/>';
	//上拉加载中的布局
...
//			},
			empty: {
				// icon: "http://47.101.195.208/web/util/dotJump/option/mescroll-empty.png", //空布局的图标
				icon:"http://47.101.195.208:10000/ImageNotFound.png",
				tip: "亲，未查询到数据~",
				// btntext: "看看其它... >", //按钮,默认""
			...
			toTop: {
				src: "http://47.101.195.208/web/util/dotJump/option/mescroll-totop.png" //回到顶部按钮的图片路径
			}
		}
	}
