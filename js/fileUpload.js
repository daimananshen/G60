...
function   uploadImg (formData) {
        ...
        // 错误监听
        xhr.addEventListener('error', ()=>{alert('upload error')}, false);
            ...
            if (xhr.readyState === 4) {
                ...
                if (xhr.status === 200) {
                    ...
                    if (result.code==0) {
                        ...
                        $("#showImage").attr('src','http://47.101.195.208:10000/uploadFile/'+imageUrl);
                    }
        ...
        xhr.open('POST', 'http://47.101.195.208/ht/fileUpload/uploadHeadImg' , true);
        xhr.send(formData);
    }